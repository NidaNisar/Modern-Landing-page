    ...
    <div>
             <div className='container mx-auto mt-25 xl:mx-auto flex flex-col lg:grid lg:grid-cols-3 gap-12 '>
                <div className=' flex flex-col gap-4' >
                    ...
                    <p className=' w-[300px] text-center mx-auto '>Our team maps out every detail from materials to milestones so your project runs smoothly from start to finish.</p>
                ...
                <div className=' flex flex-col gap-4' >
                    ...
                    <p className='text-center mx-auto w-[300px]'>We handle the selection of top-grade materials,ensuring your project stays on track with quality you can trust.</p>
                    <a href='#' className='flex justify-center'> Read more
                        <i className='ri-arrow-right-line text-accentt '></i>
                    </a>
                </div>
                <div className=' flex flex-col gap-4' >
                    ...
                    <p className='text-center w-[300px] mx-auto'>We turn plans into reality by managing execution process, delivering quality results on time and within budget.</p>
                    <a href='#' className='flex justify-center'> Read more
                        <i className='ri-arrow-right-line text-accentt '></i>
                    </a>
                </div>
